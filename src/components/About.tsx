    ...
    <>
      ...
      >
        <p
          ...
          style={{ opacity: 0.2 }}
        >
          Hey, I&apos;m Dallas Gale, a web developer and UI designer from Melbourne,
          Australia. Since 2011, I&apos;ve been creating websites for startups, large
          organisations (ABC, ACER) and agencies including ISOBAR (Dentsu), PRIME
          MOTIVE, HARDHAT, PIDGEON &amp; WARD, THINKERBELL, DIJGTAL and TODAY.
        </p>
      </section>
    </>
  );
